from helper.index_now.submit_sitemap import get_cli_input_parameters


def test_get_cli_input_parameters() -> None:
    ...
    input = get_cli_input_parameters(command_parameters)

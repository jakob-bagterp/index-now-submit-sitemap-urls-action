from helper.index_now.submit_sitemap import \
    get_submit_sitemap_cli_input_parameters


def test_get_submit_sitemap_cli_input_parameters() -> None:
    ...
    input = get_submit_sitemap_cli_input_parameters(command_parameters)
